      ...
      <div className="card p-4 rounded-3xl">
        ...
        <div className="p-4 flex flex-col gap-3 items-center justify-center text-center sm:flex-1">
          ...
          <div className="flex flex-wrap gap-4 justify-center text-lg lg:text-base font-bold">
            ...
            <div>
              <i className="fas fa-thermometer-half text-blue-500"></i> Ressenti{" "}
      ...
      <div className="flex flex-col items-center gap-3 sm:flex-1 card  rounded-3xl p-4 ">
        ...
        <div className="flex gap-4">
          <button
            ...
            className="bg-blue-700 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg w-full sm:w-auto"
          >
            Rechercher
          </button>
          <button
            onClick={handleGeolocation}
            className="bg-blue-700 hover:bg-blue-600 text-white font-bold py-3 px-4 rounded-full fas fa-location-dot text-2xl"
          >
            {" "}
          </button>
        </div>
