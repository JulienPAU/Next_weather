  ...
  return (
    <div className="container mx-auto  ">
      ...
      <div className="flex flex-wrap justify-between  w-full">
        <div className="mt-10 card p-5 rounded-3xl m-4 sm:w-5/6 lg:w-2/5">
          <h2 className="text-2xl font-semibold mb-4">Prévisions horaires</h2>
          <div className="flex flex-wrap gap-5 sm:gap-3 justify-between">
            {hourlyForecast
              .slice(currentHourIndex + 1, currentHourIndex + 11)
              .map((forecast, index) => (
                <WeatherCard
                  key={index}
                  icon={getWeatherIcon(
        ...
        <div className="mt-10 card p-5 rounded-3xl m-4 sm:w-5/6 lg:w-3/6 ">
